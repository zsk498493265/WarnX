...
<head>
    ...
    <script type="text/javascript" src="${path}/js/threshold_area_js.js"></script>
...
<div region="center" border="true" singleSelect="true">
    <table id="tt" class="easyui-datagrid" fitColumns="true"  singleSelect="true" url="${path}/threshold/getThreshold_area" title="行为阈值" striped="true">
        <thead>
        <tr>
            <th data-options="field:'id',hidden:true" rowspan="2">ID</th>
            <th data-options="field:'area',hidden:true" rowspan="2">area</th>
            <th data-options="field:'areaInfo',width:fixHtmlWidth(0.2),align:'center'," rowspan="2">区域</th>
            <th colspan="2">活动时（分钟）</th>
            <th colspan="2">休息时（分钟）</th>
            <th colspan="2">不在规律时段时（分钟）</th>
